...
'''
Названия функций говорят о себе сами, не стал их комментировать, может это и не в духе Python.
Выход из "вечного" цикла - любое число не из диапазона 3..20 
'''